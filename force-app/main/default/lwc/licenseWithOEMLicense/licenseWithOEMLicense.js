...
import getUsersByLicense from '@salesforce/apex/AnalysePackageLicenses.getUsersByLicense';
...
export default class LicenseWithOEMLicense extends LightningElement {
        //start
        columns = COLUMNS;
        @track data;
        ...
        @wire(getUsersByLicense , {ifPackageKeyNull: '$firstPackageName'})
