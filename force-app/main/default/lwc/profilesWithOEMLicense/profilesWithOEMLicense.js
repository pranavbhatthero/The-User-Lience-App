...
import getUsersByProfiles from '@salesforce/apex/AnalysePackageLicenses.getUsersByProfiles';
...
const COLUMNS = [
    { label: 'Profile', fieldName: 'Name', Type: 'text'},
...
export default class ProfilesWithOEMLicense extends LightningElement {
        //start
        columns = COLUMNS;
        @track data;
        ...
        @wire(getUsersByProfiles , {ifPackageKeyNull: '$firstPackageName'})
        myUsersProfiles(result) {
         if (result.data) {
            ...
            result.data.forEach((row) => {
                ...
                // console.log("rowData.Profile : " + rowData.Name);
