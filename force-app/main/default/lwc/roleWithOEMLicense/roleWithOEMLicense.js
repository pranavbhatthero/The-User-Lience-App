...
import getUsersByRole from '@salesforce/apex/AnalysePackageLicenses.getUsersByRole';
...
export default class RoleWithOEMLicense extends LightningElement {
        //start
        columns = COLUMNS;
        @track data;
        ...
        @wire(getUsersByRole , {ifPackageKeyNull: '$firstPackageName'})
