...
import getUsersByStatus from '@salesforce/apex/AnalysePackageLicenses.getUsersByStatus';
...
export default class StatusWithOEMLicense extends LightningElement {
        //start
        columns = COLUMNS;
        @track data;
        ...
        @wire(getUsersByStatus , {ifPackageKeyNull: '$firstPackageName'})
